...
export default function ScreenSizeIndicator() {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-50 flex items-center gap-1.5 bg-white px-1.5 py-0.5 text-sm font-bold text-black shadow">
      ...
      <span className="hidden 2xl:block fhd:hidden">2XL</span>
      <span className="hidden fhd:block 2k:hidden">FHD</span>
      <span className="hidden 2k:block 4k:hidden">2K</span>
      <span className="hidden 4k:block">4K</span>
